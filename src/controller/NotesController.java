...
public class NotesController {
    ...
    public List<SelfNote> getallNotes(){
        return dao.getAllNotesByUser(userId);
    }
    
    public void updateNote(int id, String title, String content){
        SelfNote note = new SelfNote(0, title, content, userId);
        dao.updateNote(note);
    }
...
//    public NotesController(NotesDAO dao, UserSelfNote view) {
//        this.dao = dao;
//        this.view = view;
//
//        view.AddaddNoteListener(new AddNoteListener());
////        loadNotes();
//    }
//    public void open(){
