 ...
 * @author Jay pradhan
 */
public class Katsu_bowl extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 290, 80, 30));

        jTextArea2.setEditable(false);
        jTextArea2.setBackground(new java.awt.Color(255, 255, 255));
        jTextArea2.setColumns(20);
        jTextArea2.setRows(5);
        jTextArea2.setText("-Cook rice according to package instructions; keep warm.\n\n-Season the pork or chicken cutlets with salt and pepper.\n\n-Dredge each cutlet in flour, dip in beaten eggs, then coat in panko breadcrumbs.\n\n-Heat oil in a skillet over medium-high heat.\n\n-Fry cutlets until golden brown and cooked through, about 3–4 minutes per side.\n\n-Drain on paper towels and slice into strips.\n\n-In a small saucepan, combine soy sauce, sugar, mirin, and ketchup; simmer for 2–3 minutes.\n\n-Divide rice into bowls.\n\n-Top with sliced cutlet.\n\n-Drizzle sauce generously over the top.\n\n-Garnish with shredded cabbage, green onions, or sesame seeds if desired.\n");
        jScrollPane3.setViewportView(jTextArea2);

        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 330, 260, 360));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel6.setText("Ingredients: 12");
        ...
        jTextArea3.setText("-2 cups cooked white rice\n\n-2 boneless pork chops or chicken breasts\n\n-Salt and pepper, to taste\n\n-1/4 cup all-purpose flour\n\n-2 eggs, beaten\n\n-1 cup panko breadcrumbs\n\n-1/2 cup oil (vegetable or canola, for frying)\n\n-2 tablespoons soy sauce\n\n-1 tablespoon sugar\n\n-1 tablespoon mirin (or substitute with sweet rice wine or a splash of honey)\n\n-1 tablespoon ketchup\n\n-Optional toppings: shredded cabbage, sliced green onions, sesame seeds");
        jScrollPane5.setViewportView(jTextArea3);

        jPanel1.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 330, 270, 360));

        jPanel4.setBackground(new java.awt.Color(255, 255, 255));
        jPanel4.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, null, null, null, new java.awt.Color(255, 153, 153)));
        jPanel4.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jButton3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton3.setForeground(new java.awt.Color(127, 1, 31));
        jButton3.setText("Bookmarked");
        ...
        jPanel6.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, null, null, null, new java.awt.Color(255, 102, 102)));
        jPanel6.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jButton5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jButton5.setForeground(new java.awt.Color(127, 1, 31));
        jButton5.setText("Mark As Complete");
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 700));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Katsu_bowl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Katsu_bowl().setVisible(true);
            }
        });
    }
